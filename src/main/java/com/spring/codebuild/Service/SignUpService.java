...
public class SignUpService extends UserValidator {
    ...
    private final EmailSerivceImpl emailService;
    private final UserDAO userDAO;
    private final CandidateDAO candidateDAO;

    @Autowired
    public SignUpService(UserDAO userDAO, EmailSerivceImpl emailService, CandidateDAO candidateDAO) {
    ...
    public String confirm(User user) {
        ...
        claims.put("Password", candidate.getPassword());
